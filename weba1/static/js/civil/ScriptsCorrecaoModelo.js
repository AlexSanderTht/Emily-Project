...
var NomeEtapa = "Correção de Modelo";
...
function CriarComentarioForm() {
     $.ajax({
        ...
        type : "POST", // http method
        data : { Comentario : $('#observacao-comentario').val(), AtividadeID : $('#IDAtiv').html(), Origem: "Correção Modelo" }, // data sent with the post request
