...
var IDSelecionado = $( "#ResponsavelEstudo option:selected" ).text();
var Data = $("#DataEstudoVlrForm").val();
...
if(IDSelecionado != "---------")
{
    ...
    var IDEstudo = $("#IDEstudo").html();
      $.ajax({
            url : "/app/civil/Estudo/"+IDEstudo+"/", // the endpoint
            type : "POST", // http method
            data : { IDEstudo : IDEstudo, IDStatus : StatusNovo, IDPessoa: IDSelecionado, DataOp: Data}, // data sent with the post request
...
function CriarComentarioForm() {
     $.ajax({
        ...
        type : "POST", // http method
        data : { Comentario : $('#observacao-comentario').val(), AtividadeID : $('#IDAtiv').html(), Origem: "Estudo" }, // data sent with the post request
