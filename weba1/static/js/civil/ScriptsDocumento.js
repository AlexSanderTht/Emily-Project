...
var OpcoesSemPreencher = [];
   ...
   {
        $.ajax({
            url : "/app/app/civil/civil/LVES/", // the endpoint
            type : "POST", // http method
            dataType : "json",
...
var IDSelecionado = $( "#ResponsavelDocumento option:selected" ).text();
...
if(IDSelecionado != "---------")
{
    ...
    var IDDocumento = $("#IDDocumento").html();
      $.ajax({
            url : "/app/civil/Documento/"+IDDocumento+"/", // the endpoint
            type : "POST", // http method
            data : { IDDocumento : IDDocumento, IDStatus : StatusNovo, IDPessoa: IDSelecionado, DataOp: Data }, // data sent with the post request
...
function CriarComentarioForm() {
     $.ajax({
        ...
        type : "POST", // http method
        data : { Comentario : $('#observacao-comentario').val(), AtividadeID : $('#IDAtiv').html(), Origem: "Documento" }, // data sent with the post request
