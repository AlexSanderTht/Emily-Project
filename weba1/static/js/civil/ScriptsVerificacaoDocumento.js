...
var NomeEtapa = "Verificação de Documento";
                   ...
                   if(ItemsSelecionados[k].Grupo == Grupos[j] && ItemsSelecionados[k].Selecao == Selecoes[i])
                   {
                       ...
                       else
                       {
                        ...
                        var el = jQuery('<div style="display: table-cell; vertical-align: middle;"><p class="TextoLVE" >'+ItemsSelecionados[k].Nome+"</p></div>", {
                            ...
                            {
                                    var el = jQuery(`<div class="tituloAV" style="background-color: #6c757d66" title="Auto Verificação - Não se Aplica"><center>AV<center></div>`, {
                                 }).appendTo('#GridBts'+i+j+k);
                        ...
                        /*    var el = jQuery(`
                         ...
                         var HTMLHeader = "";
                            ...
                            {
                                   var el = jQuery(`<div class="tituloAV" id="TituloAV${i}${j}${k}" style=" background-color: #cbc3ba" title="Verificação - Não se Aplica"><center>V<center></div>`, {
                                }).appendTo('#GridBts'+i+j+k);
                                CorBotaoNA = "#cbc3ba";
                            }
...
function CriarComentarioForm() {
     $.ajax({
        ...
        type : "POST", // http method
        data : { Comentario : $('#observacao-comentario').val(), AtividadeID : $('#IDAtiv').html(), Origem: "Verificação Documento" }, // data sent with the post request
