...
echo ========================================
echo Worker Celery - files_using_dwg
echo ========================================

REM Configuracoes
set WORKER_NAME=worker_files_dwg
set QUEUE_NAME=files_using_dwg
set LOG_FILE=logs/celery_logs_dwg.log
set MAX_RETRIES=5
set RETRY_DELAY=10
...
celery -A weba1 worker -Q %QUEUE_NAME% -l info -f %LOG_FILE% -n %WORKER_NAME%@%COMPUTERNAME% --concurrency 1 --pool solo --max-tasks-per-child 1000 --time-limit 3600 --soft-time-limit 3000 --autoscale 1,1
